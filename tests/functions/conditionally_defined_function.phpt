--TEST--
PHP Spec test generated from ./functions/conditionally_defined_function.php
--FILE--
<?php
...
cf2();		// Ok
--EXPECT--
Inside unconditionally defined function ucf1
Inside unconditionally defined function ucf1
Inside conditionally defined function cf1
Inside conditionally defined function cf2