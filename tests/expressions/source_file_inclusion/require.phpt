...
--EXPECTF--
Inside file >%s%eexpressions%esource_file_inclusion%erequire.php< at line >11< with namespace ><
================= xxx =================
Inside file >%s%eexpressions%esource_file_inclusion%elimits.inc< at line >14< with namespace >MyInclude<
int(1)
Inside file >%s%eexpressions%esource_file_inclusion%erequire.php< at line >29< with namespace ><
Inside file >%s%eexpressions%esource_file_inclusion%emycolors.inc< at line >13< with namespace >MyColors<
int(1)
Inside file >%s%eexpressions%esource_file_inclusion%erequire.php< at line >37< with namespace ><
----------------------------------
...
----------------------------------
----------------------------------
Inside file >%s%eexpressions%esource_file_inclusion%erequire.php< at line >86<
----------------------------------
int(100)
====
Array
(
    [0] => %s%eexpressions%esource_file_inclusion%erequire.php
...
int(1)
----------------------------------
Inside file >%s%eexpressions%esource_file_inclusion%erequire.php< at line >95<
...
$v1: , $v2: 
$local1: 100
Inside file >%s%eexpressions%esource_file_inclusion%erequire.php< at line >99<
----------------------------------
Array
(
    [0] => %s%eexpressions%esource_file_inclusion%erequire.php
